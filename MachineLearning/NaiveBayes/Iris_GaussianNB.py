...
if __name__=='__main__':
    data = np.loadtxt('F:\project\MachineLearning\MachineLearning\Data\Regression\iris.data', dtype=float, delimiter=',', converters={4: iris_type})
    print(data)
