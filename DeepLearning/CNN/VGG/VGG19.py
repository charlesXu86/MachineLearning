...
@file: VGG19.py 
@desc: VGG
   github: https://github.com/hjptriplebee/VGG19_with_tensorflow/blob/master/vgg19.py
   https://github.com/jackfan00/VGG
@time: 2017/09/29 
"""
...
def maxPoolLayer(x, kWidth, kHeight, strideX, strideY, name, padding= "SAME"):
    """
      max-pooling
    """
...
class VGG19(object):
    ...
    def buildCNN(self):
        ...
        dropOut1 =dropOut(fc6, self.KEEPPEO)

        fc7 = fcLayer(dropOut1, 4096, 4096, True, "fc7")
        dropOut2 = dropOut(fc7, self.KEEPPEO)
